...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['isSubmitted'])) {
    ...
    $database->store($table, $fullName, $email, $password, $confirmPassword, $redirect);
}
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <form method="post" action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                            ...
                            <div class="mb-3">
                                <label for="username" class="form-label fw-medium">Fullname</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light border-end-0">
                                        <i class="bi bi-person-fill text-muted"></i>
                                    </span>
                                    <input type="text" class="form-control border-start-0 ps-0" id="fullname"
                                        name="fullname" placeholder="Enter Fullname" autofocus>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="d-grid">
                                ...
                                <a href="login.php" class="btn btn-outline-dark mt-2 fs-6">
